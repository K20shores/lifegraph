...
def single_axes_example(path=None):
    ...
    if path:
        fig.savefig(f"{path}/provided_axes_single.png", dpi=300)
    else:
        fig.savefig("images/provided_axes_single.png", dpi=300)
...
def multiple_subplots_example(path=None):
    ...
    if path:
        fig.savefig(f"{path}/provided_axes_multiple.png", dpi=300)
    else:
        fig.savefig("images/provided_axes_multiple.png", dpi=300)
...
def mixed_plot_example(path=None):
    ...
    if path:
        fig.savefig(f"{path}/provided_axes_mixed.png", dpi=300)
    else:
        fig.savefig("images/provided_axes_mixed.png", dpi=300)
...
def test_provided_axes(tmp_path):
